...
1. Navigate to the application by clicking the Heroku Deploy Link: 
 > Upon navigating to the deployed application link, you will be greeted with a home screen. To begin using the application, simply click the "Get Started" button.
2. Simply create a note by clicking the pencil icon. You may begin writing a title of the note, and you may click below to write the note's content.
3. If you wish to save the note for future viewing, you may click the save icon which will appear after filling out the note's content. Once you save the note, it will appear on the left-hand side of the screen, and can be clicked on to be viewed at a later time. Note that once you save a note, it can no longer be edited.
